...
async function applyReturnsMigration() {
  try {
    console.log('=== APLICANDO MIGRAÇÃO DE DEVOLUÇÕES ===');
    
    // 1. Criar tipos ENUM
    console.log('1. Criando tipos ENUM...');
    ...
    console.log('2. Criando tabela returns...');
    await supabase.rpc('exec_sql', {
      sql: `
    ...
    console.log('✅ Tabela returns criada');
    
    // 3. Criar tabela return_items
    console.log('3. Criando tabela return_items...');
    await supabase.rpc('exec_sql', {
      sql: `
    ...
    console.log('✅ Tabela return_items criada');
    
    // 4. Criar tabela exchange_items
    console.log('4. Criando tabela exchange_items...');
    await supabase.rpc('exec_sql', {
      sql: `
    ...
    console.log('✅ Tabela exchange_items criada');
    
    // 5. Criar tabela store_credits
    console.log('5. Criando tabela store_credits...');
    await supabase.rpc('exec_sql', {
      sql: `
    ...
    console.log('✅ Tabela store_credits criada');
    
    // 6. Criar tabela store_credit_transactions
    console.log('6. Criando tabela store_credit_transactions...');
    await supabase.rpc('exec_sql', {
      sql: `
    ...
    console.log('✅ Tabela store_credit_transactions criada');
    ...
    // 9. Criar políticas
    console.log('9. Criando políticas...');
    await supabase.rpc('exec_sql', {
      sql: `
    ...
    console.log('🎉 MIGRAÇÃO DE DEVOLUÇÕES APLICADA COM SUCESSO!');
    console.log('Agora você pode acessar a página de devoluções em /returns');
